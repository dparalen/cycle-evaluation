...
performance in an experiment. Here, Lotka-Volterra and Bayramov
...
integration takes $2000$ constant steps from the range $\langle 0.0,
10.0\rangle$.
...
From Table \ref{tab:lv:03}, it can be seen if $\varepsilon>grid\:step$,
